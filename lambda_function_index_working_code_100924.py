...
def lambda_handler(event, context):
    ...
    try:
        ...
        prompt = f"""You are an excellent story writer. You have been asked to generate a {story_type} story about {main_character} who lives in {setting}. 
                     ...
                     At the end, create one meaningful key point from each paragraph of the story. These key points should be related to each other.
        \n\nAssistant:"""
        ...
        key_points_section = response_text.split("Key Points:")[1].strip()
        ...
        native_request1 = {"text_prompts":[{"text":prompt1,"weight":1}],"cfg_scale":10,"steps":50,"seed":0,"width":1024,"height":512,"samples":1}
        ...
        native_request2 = {"text_prompts":[{"text":prompt2,"weight":1}],"cfg_scale":10,"steps":50,"seed":0,"width":1024,"height":512,"samples":1}
        ...
        native_request3 = {"text_prompts":[{"text":prompt3,"weight":1}],"cfg_scale":10,"steps":50,"seed":0,"width":1024,"height":512,"samples":1}
        ...
        native_request4 = {"text_prompts":[{"text":prompt4,"weight":1}],"cfg_scale":10,"steps":50,"seed":0,"width":1024,"height":512,"samples":1}
